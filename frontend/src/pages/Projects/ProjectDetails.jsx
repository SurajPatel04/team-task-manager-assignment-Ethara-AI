        ...
        <div className="max-w-[1400px] mx-auto px-8 py-8 animate-in fade-in duration-500 font-sans text-slate-900">
            ...
            <div className="flex items-center gap-1 mb-8 border-b border-slate-200">
                <button
                    ...
                    className={`px-6 py-3 text-[14px] font-bold transition-all border-b-2 -mb-[2px] flex items-center gap-2 ${activeMainTab === 'tasks'
                ...
                <button
                    ...
                    className={`px-6 py-3 text-[14px] font-bold transition-all border-b-2 -mb-[2px] flex items-center gap-2 ${activeMainTab === 'members'
                            ? 'border-[#0F172A] text-[#0F172A]'
                            : 'border-transparent text-slate-500 hover:text-slate-700'
                        }`}
                >
            ...
            {activeMainTab === 'tasks' ? (
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            {userRole === 'admin' && (
                                <button
                                    ...
                                    className="bg-[#0F172A] text-white px-4 py-2.5 rounded-[8px] text-[13px] font-semibold flex items-center gap-2 shadow-sm hover:opacity-90 transition-colors"
                                >
                        ...
                        <div className="flex items-center bg-slate-100 p-1 rounded-lg self-start">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-md text-[11px] font-bold transition-all whitespace-nowrap ${activeTaskTab === tab.id
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <select
                                                            ...
                                                            className={`text-[12px] font-semibold rounded-full px-2 py-1 border-0 outline-none cursor-pointer appearance-none ${task.status === 'done'
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {Array.from({ length: taskPagination.totalPages || 1 }, (_, i) => i + 1).map((pg) => (
                                <button
                                    ...
                                    className={`w-9 h-9 rounded-[8px] text-[13px] font-bold transition-colors ${pg === taskPage
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <h2 className="text-[20px] font-bold text-slate-900">Team Members</h2>
                            <p className="text-[13px] text-slate-500 hidden sm:block">Manage who has access to this project</p>
                        </div>
                        {userRole === 'admin' && (
                            <button
                                onClick={() => setIsInviteModalOpen(true)}
                                className="bg-[#0F172A] text-white px-4 py-2.5 rounded-[8px] text-[13px] font-bold flex items-center gap-2 shadow-sm hover:opacity-90 transition-all active:scale-95 whitespace-nowrap"
                            >
                                <Plus className="w-4 h-4" />
                                                ...
                                                <tr key={member.userId?._id || member._id} className="hover:bg-slate-50/50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-5">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className={`text-[12px] font-bold uppercase tracking-wider ${member.role === 'admin' ? 'text-indigo-600' : 'text-slate-500'
                                                                }`}>
                                                                {member.role}
                                                            </span>
                                                        </div>
